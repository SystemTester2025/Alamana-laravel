            ...
            <form action="{{ route('sections.update', $section->id) }}" method="POST">
                ...
                <div class="row">
                    <div class="col-md-6 mb-3">
                        ...
                        <input type="text" disabled class="form-control @error('name') is-invalid @enderror" id="name" name="name" value="{{ old('name', $section->name) }}" required>
                    ...
                    <div class="col-md-6 mb-3">
                        ...
                        <input type="text" disabled class="form-control @error('slug') is-invalid @enderror" id="slug" name="slug" value="{{ old('slug', $section->slug) }}">
                        <div class="form-text">سيتم إنشاؤه تلقائياً من اسم القسم إذا تركته فارغاً</div>
                        @error('slug')
                            <div class="invalid-feedback">{{ $message }}</div>
                        @enderror
                    </div>
